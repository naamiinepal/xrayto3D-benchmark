...
gpu=0
batch_size=8
testpaths=configs/angle_perturbation/TotalSegmentor-hips-DRR-full_test_1.csv
angle=1
...
gpu=0
batch_size=8
testpaths=configs/angle_perturbation/TotalSegmentor-hips-DRR-full_test_2.csv
angle=2
...
gpu=0
batch_size=8
testpaths=configs/angle_perturbation/TotalSegmentor-hips-DRR-full_test_5.csv
angle=5
...
gpu=0
batch_size=8
testpaths=configs/angle_perturbation/TotalSegmentor-hips-DRR-full_test_10.csv
angle=10
