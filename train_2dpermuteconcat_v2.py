...
from XrayTo3DShape import get_dataset,get_nonkasten_transforms,BiplanarAsInputExperiment,NiftiPredictionWriter,parse_training_arguments,TwoDPermuteConcat
...
if __name__ == '__main__':
    ...
    model = TwoDPermuteConcat(model_config)
